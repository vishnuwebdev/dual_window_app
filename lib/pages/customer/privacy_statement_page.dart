...
/// POPIA consent screen shown before the **collection** journey's phone/PIN
/// entry ([CollectionInputPage]). Previously this same content also gated
/// the drop-off journey (paired with a disclaimer screen), but both were
/// removed from drop-off per product request — collection keeps only this
/// privacy screen, with no disclaimer screen of its own.
